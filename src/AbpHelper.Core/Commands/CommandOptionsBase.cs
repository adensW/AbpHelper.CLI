...
namespace EasyAbp.AbpHelper.Core.Commands
{
    public abstract class CommandOptionsBase
    {
        ...
        [Option("subname", Description = "The ABP project sub name. Example: project file: 'Acme.BookStore.Admin.Application.csproj', the name is 'BookStore' and the subname is 'Admin'")]
        public virtual string Subname { get; set; } = null!;
